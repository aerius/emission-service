...
import nl.aerius.emissionservice.repository.DatasetRepository;
...
class DatasetHelperTest {
  ...
  void testValidateDatasetWithUnknownDataset() {
    ...
    assertEquals(HttpStatus.NOT_FOUND, exception.getStatusCode(), "Status used when dataset unknown");
