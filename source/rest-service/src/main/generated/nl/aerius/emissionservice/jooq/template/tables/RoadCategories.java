...
import nl.aerius.emissionservice.jooq.template.tables.records.RoadCategoriesRecord;
...
public class RoadCategories extends TableImpl<RoadCategoriesRecord> {
     ...
     */
    public final TableField<RoadCategoriesRecord, RoadType> ROAD_TYPE = createField(DSL.name("road_type"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(nl.aerius.emissionservice.jooq.public_.enums.RoadType.class), this, "");

    /**
     * The column <code>template.road_categories.vehicle_type</code>.
     */
    public final TableField<RoadCategoriesRecord, VehicleType> VEHICLE_TYPE = createField(DSL.name("vehicle_type"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(nl.aerius.emissionservice.jooq.public_.enums.VehicleType.class), this, "");
