...
import nl.aerius.emissionservice.jooq.public_.enums.VehicleType;
import nl.aerius.emissionservice.jooq.template.Template;
import nl.aerius.emissionservice.jooq.template.tables.records.RoadCategoriesViewRecord;
...
public class RoadCategoriesView extends TableImpl<RoadCategoriesViewRecord> {
     ...
     */
    public final TableField<RoadCategoriesViewRecord, VehicleType> VEHICLE_TYPE = createField(DSL.name("vehicle_type"), org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(nl.aerius.emissionservice.jooq.public_.enums.VehicleType.class), this, "");

    /**
     * The column <code>template.road_categories_view.road_type</code>.
     */
    public final TableField<RoadCategoriesViewRecord, RoadType> ROAD_TYPE = createField(DSL.name("road_type"), org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(nl.aerius.emissionservice.jooq.public_.enums.RoadType.class), this, "");
     ...
     */
    public final TableField<RoadCategoriesViewRecord, SpeedLimitEnforcementType> SPEED_LIMIT_ENFORCEMENT = createField(DSL.name("speed_limit_enforcement"), org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(nl.aerius.emissionservice.jooq.public_.enums.SpeedLimitEnforcementType.class), this, "");
