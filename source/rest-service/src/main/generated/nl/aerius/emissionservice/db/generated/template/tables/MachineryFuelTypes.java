...
import nl.aerius.emissionservice.db.generated.template.tables.records.MachineryFuelTypesRecord;
...
public class MachineryFuelTypes extends TableImpl<MachineryFuelTypesRecord> {
    ...
    /**
     * The column
     * <code>template.machinery_fuel_types.machinery_fuel_type_id</code>.
     */
    public final TableField<MachineryFuelTypesRecord, Integer> MACHINERY_FUEL_TYPE_ID = createField(DSL.name("machinery_fuel_type_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>template.machinery_fuel_types.code</code>.
     */
    public final TableField<MachineryFuelTypesRecord, String> CODE = createField(DSL.name("code"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>template.machinery_fuel_types.name</code>.
     */
    public final TableField<MachineryFuelTypesRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>template.machinery_fuel_types.density</code>.
     */
    public final TableField<MachineryFuelTypesRecord, Float> DENSITY = createField(DSL.name("density"), nl.aerius.emissionservice.db.generated.public_.Domains.POSREAL.getDataType().nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>template.machinery_fuel_types</code> table
     * reference
     */
    ...
    @Override
    public List<UniqueKey<MachineryFuelTypesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.MACHINERY_FUEL_TYPES_CODE_KEY, Keys.MACHINERY_FUEL_TYPES_NAME_KEY);
    }
    ...
    @Override
    public MachineryFuelTypes as(Table<?> alias) {
        return new MachineryFuelTypes(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public MachineryFuelTypes rename(Table<?> name) {
        return new MachineryFuelTypes(name.getQualifiedName(), null);
    }
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super Integer, ? super String, ? super String, ? super Float, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super Integer, ? super String, ? super String, ? super Float, ? extends U> from) {
