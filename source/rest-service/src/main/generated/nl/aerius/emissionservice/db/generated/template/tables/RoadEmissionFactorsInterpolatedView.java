...
import nl.aerius.emissionservice.db.generated.template.tables.records.RoadEmissionFactorsInterpolatedViewRecord;
...
public class RoadEmissionFactorsInterpolatedView extends TableImpl<RoadEmissionFactorsInterpolatedViewRecord> {
     ...
     * <code>template.road_emission_factors_interpolated_view</code>
     */
    ...
    /**
     * The column
     * <code>template.road_emission_factors_interpolated_view.road_category_id</code>.
     */
    public final TableField<RoadEmissionFactorsInterpolatedViewRecord, Integer> ROAD_CATEGORY_ID = createField(DSL.name("road_category_id"), SQLDataType.INTEGER, this, "");

    /**
     * The column
     * <code>template.road_emission_factors_interpolated_view.road_speed_profile_id</code>.
     */
    public final TableField<RoadEmissionFactorsInterpolatedViewRecord, Integer> ROAD_SPEED_PROFILE_ID = createField(DSL.name("road_speed_profile_id"), SQLDataType.INTEGER, this, "");

    /**
     * The column
     * <code>template.road_emission_factors_interpolated_view.year</code>.
     */
    public final TableField<RoadEmissionFactorsInterpolatedViewRecord, Short> YEAR = createField(DSL.name("year"), nl.aerius.emissionservice.db.generated.public_.Domains.YEAR_TYPE.getDataType(), this, "");

    /**
     * The column
     * <code>template.road_emission_factors_interpolated_view.substance_id</code>.
     */
    public final TableField<RoadEmissionFactorsInterpolatedViewRecord, Short> SUBSTANCE_ID = createField(DSL.name("substance_id"), SQLDataType.SMALLINT, this, "");

    /**
     * The column
     * <code>template.road_emission_factors_interpolated_view.emission_factor</code>.
     */
    public final TableField<RoadEmissionFactorsInterpolatedViewRecord, Double> EMISSION_FACTOR = createField(DSL.name("emission_factor"), SQLDataType.DOUBLE, this, "");

    /**
     * The column
     * <code>template.road_emission_factors_interpolated_view.stagnated_emission_factor</code>.
     */
    public final TableField<RoadEmissionFactorsInterpolatedViewRecord, Double> STAGNATED_EMISSION_FACTOR = createField(DSL.name("stagnated_emission_factor"), SQLDataType.DOUBLE, this, "");
    ...
    private RoadEmissionFactorsInterpolatedView(Name alias, Table<RoadEmissionFactorsInterpolatedViewRecord> aliased, Field<?>[] parameters) {
        ...
        create view "road_emission_factors_interpolated_view" as  SELECT road_emission_factors_interpolation_years_view.road_category_id,
    ...
    /**
     * Create an aliased
     * <code>template.road_emission_factors_interpolated_view</code> table
     * reference
     */
    ...
    /**
     * Create a <code>template.road_emission_factors_interpolated_view</code>
     * table reference
     */
    ...
    @Override
    public RoadEmissionFactorsInterpolatedView as(Table<?> alias) {
        return new RoadEmissionFactorsInterpolatedView(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public RoadEmissionFactorsInterpolatedView rename(Table<?> name) {
        return new RoadEmissionFactorsInterpolatedView(name.getQualifiedName(), null);
    }
