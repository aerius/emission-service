...
import nl.aerius.emissionservice.jooq.template.tables.records.I18nFarmLodgingSystemDefinitionsRecord;
...
public class I18nFarmLodgingSystemDefinitions extends TableImpl<I18nFarmLodgingSystemDefinitionsRecord> {
    ...
    /**
     * The column <code>template.i18n_farm_lodging_system_definitions.farm_lodging_system_definition_id</code>.
     */
    public final TableField<I18nFarmLodgingSystemDefinitionsRecord, Integer> FARM_LODGING_SYSTEM_DEFINITION_ID = createField(DSL.name("farm_lodging_system_definition_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>template.i18n_farm_lodging_system_definitions.language_code</code>.
     */
    public final TableField<I18nFarmLodgingSystemDefinitionsRecord, LanguageCodeType> LANGUAGE_CODE = createField(DSL.name("language_code"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(nl.aerius.emissionservice.jooq.i18n.enums.LanguageCodeType.class), this, "");

    /**
     * The column <code>template.i18n_farm_lodging_system_definitions.description</code>.
     */
    public final TableField<I18nFarmLodgingSystemDefinitionsRecord, String> DESCRIPTION = createField(DSL.name("description"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * Create a <code>template.i18n_farm_lodging_system_definitions</code> table reference
     */
    ...
    /**
     * Create an aliased <code>template.i18n_farm_lodging_system_definitions</code> table reference
     */
    ...
    @Override
    public List<UniqueKey<I18nFarmLodgingSystemDefinitionsRecord>> getKeys() {
        return Arrays.<UniqueKey<I18nFarmLodgingSystemDefinitionsRecord>>asList(Keys.I18N_FARM_LODGING_SYSTEM_DEFINITIONS_PKEY);
    }

    @Override
    public List<ForeignKey<I18nFarmLodgingSystemDefinitionsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<I18nFarmLodgingSystemDefinitionsRecord, ?>>asList(Keys.I18N_FARM_LODGING_SYSTEM_DEFINITIONS__I18N_FARM_LODGING_SYSTEM_DEFINITIONS_FKEY);
    }

    public FarmLodgingSystemDefinitions farmLodgingSystemDefinitions() {
        return new FarmLodgingSystemDefinitions(this, Keys.I18N_FARM_LODGING_SYSTEM_DEFINITIONS__I18N_FARM_LODGING_SYSTEM_DEFINITIONS_FKEY);
    }
