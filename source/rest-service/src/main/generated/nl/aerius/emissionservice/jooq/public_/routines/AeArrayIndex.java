...
public class AeArrayIndex extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1055250002;

    /**
     * The parameter <code>public.ae_array_index.RETURN_VALUE</code>.
     */
     ...
     */
    public AeArrayIndex() {
        super("ae_array_index", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
