...
import nl.aerius.emissionservice.db.generated.template.tables.records.FarmReductiveLodgingSystemsRecord;
...
public class FarmReductiveLodgingSystems extends TableImpl<FarmReductiveLodgingSystemsRecord> {
     ...
     * <code>template.farm_reductive_lodging_systems</code>
     */
    ...
    /**
     * The column
     * <code>template.farm_reductive_lodging_systems.farm_reductive_lodging_system_id</code>.
     */
    public final TableField<FarmReductiveLodgingSystemsRecord, Integer> FARM_REDUCTIVE_LODGING_SYSTEM_ID = createField(DSL.name("farm_reductive_lodging_system_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column
     * <code>template.farm_reductive_lodging_systems.farm_animal_category_id</code>.
     */
    public final TableField<FarmReductiveLodgingSystemsRecord, Integer> FARM_ANIMAL_CATEGORY_ID = createField(DSL.name("farm_animal_category_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>template.farm_reductive_lodging_systems.code</code>.
     */
    public final TableField<FarmReductiveLodgingSystemsRecord, String> CODE = createField(DSL.name("code"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>template.farm_reductive_lodging_systems.name</code>.
     */
    public final TableField<FarmReductiveLodgingSystemsRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column
     * <code>template.farm_reductive_lodging_systems.description</code>.
     */
    public final TableField<FarmReductiveLodgingSystemsRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>template.farm_reductive_lodging_systems.scrubber</code>.
     */
    public final TableField<FarmReductiveLodgingSystemsRecord, Boolean> SCRUBBER = createField(DSL.name("scrubber"), SQLDataType.BOOLEAN.nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>template.farm_reductive_lodging_systems</code>
     * table reference
     */
    ...
    /**
     * Create a <code>template.farm_reductive_lodging_systems</code> table
     * reference
     */
    ...
    @Override
    public List<UniqueKey<FarmReductiveLodgingSystemsRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.FARM_REDUCTIVE_LODGING_SYSTEMS_CODE_KEY, Keys.FARM_REDUCTIVE_LODGING_SYSTEMS_NAME_KEY);
    }

    @Override
    public List<ForeignKey<FarmReductiveLodgingSystemsRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FARM_REDUCTIVE_LODGING_SYSTEMS__FARM_REDUCTIVE_LODGING_SYSTEMS_FKEY_FARM_ANIMAL_CATEGORIES);
    }
    ...
    public FarmAnimalCategories farmAnimalCategories() {
        if (_farmAnimalCategories == null)
            _farmAnimalCategories = new FarmAnimalCategories(this, Keys.FARM_REDUCTIVE_LODGING_SYSTEMS__FARM_REDUCTIVE_LODGING_SYSTEMS_FKEY_FARM_ANIMAL_CATEGORIES);
    ...
    @Override
    public FarmReductiveLodgingSystems as(Table<?> alias) {
        return new FarmReductiveLodgingSystems(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public FarmReductiveLodgingSystems rename(Table<?> name) {
        return new FarmReductiveLodgingSystems(name.getQualifiedName(), null);
    }
