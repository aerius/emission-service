...
import nl.aerius.emissionservice.db.generated.template.tables.records.MobileSourceOnRoadCategoriesRecord;
...
public class MobileSourceOnRoadCategories extends TableImpl<MobileSourceOnRoadCategoriesRecord> {
     ...
     * <code>template.mobile_source_on_road_categories</code>
     */
     ...
     */
    public final TableField<MobileSourceOnRoadCategoriesRecord, Short> MOBILE_SOURCE_ON_ROAD_CATEGORY_ID = createField(DSL.name("mobile_source_on_road_category_id"), SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>template.mobile_source_on_road_categories.code</code>.
     */
    public final TableField<MobileSourceOnRoadCategoriesRecord, String> CODE = createField(DSL.name("code"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>template.mobile_source_on_road_categories.name</code>.
     */
    public final TableField<MobileSourceOnRoadCategoriesRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column
     * <code>template.mobile_source_on_road_categories.description</code>.
     */
    public final TableField<MobileSourceOnRoadCategoriesRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB, this, "");
    ...
    /**
     * Create an aliased <code>template.mobile_source_on_road_categories</code>
     * table reference
     */
    ...
    /**
     * Create a <code>template.mobile_source_on_road_categories</code> table
     * reference
     */
    ...
    @Override
    public List<UniqueKey<MobileSourceOnRoadCategoriesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.MOBILE_SOURCE_ON_ROAD_CATEGORIES_CODE_KEY, Keys.MOBILE_SOURCE_ON_ROAD_CATEGORIES_NAME_KEY);
    }
    ...
    @Override
    public MobileSourceOnRoadCategories as(Table<?> alias) {
        return new MobileSourceOnRoadCategories(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public MobileSourceOnRoadCategories rename(Table<?> name) {
        return new MobileSourceOnRoadCategories(name.getQualifiedName(), null);
    }
