...
BEGIN; SELECT setup.ae_load_table('nature2021.sector_default_source_characteristics', '{data_folder}/temp/temp_sector_default_source_characteristics_20200612.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('nature2021.gcn_sector_source_characteristics', '{data_folder}/public/gcn_sector_source_characteristics_20190222.txt'); COMMIT;
