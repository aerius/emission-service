...
BEGIN; SELECT setup.ae_load_table('nature2021.i18n_mobile_source_off_road_categories', '{data_folder}/i18n/i18n.mobile_source_off_road_categories_20210923.txt', TRUE); COMMIT;

BEGIN; SELECT setup.ae_load_table('nature2021.i18n_road_area_categories', '{data_folder}/i18n/i18n.road_area_categories_20220203.txt', TRUE); COMMIT;

BEGIN; SELECT setup.ae_load_table('nature2021.i18n_road_type_categories', '{data_folder}/i18n/i18n.road_type_categories_20220616.txt', TRUE); COMMIT;

BEGIN; SELECT setup.ae_load_table('nature2021.i18n_road_vehicle_categories', '{data_folder}/i18n/i18n.road_vehicle_categories_20220203.txt', TRUE); COMMIT;

BEGIN;
	INSERT INTO nature2021.i18n_mobile_source_on_road_categories (mobile_source_on_road_category_id, language_code, name, description)
	SELECT mobile_source_on_road_category_id, unnest(ARRAY['nl', 'en']::i18n.language_code_type[]), name, description FROM nature2021.mobile_source_on_road_categories;
COMMIT;
