...
BEGIN; SELECT setup.ae_load_table('nature2021.farm_lodging_system_definitions', '{data_folder}/public/farm_lodging_system_definitions_20210607.txt'); COMMIT;

BEGIN; SELECT setup.ae_load_table('nature2021.farm_lodging_types', '{data_folder}/public/farm_lodging_types_20210607.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('nature2021.farm_lodging_type_emission_factors', '{data_folder}/public/farm_lodging_type_emission_factors_20210607.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('nature2021.farm_lodging_types_other_lodging_type', '{data_folder}/public/farm_lodging_types_other_lodging_type_20210607.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('nature2021.farm_lodging_types_to_lodging_system_definitions', '{data_folder}/public/farm_lodging_types_to_lodging_system_definitions_20210607.txt'); COMMIT;
...
BEGIN; SELECT setup.ae_load_table('nature2021.farm_reductive_lodging_systems', '{data_folder}/public/farm_reductive_lodging_systems_20210607.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('nature2021.farm_reductive_lodging_system_reduction_factors', '{data_folder}/public/farm_reductive_lodging_system_reduction_factors_20210607.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('nature2021.farm_reductive_lodging_systems_to_lodging_system_definitions', '{data_folder}/public/farm_reductive_lodging_systems_to_lodging_system_definitions_20210607.txt'); COMMIT;
