...
BEGIN; SELECT setup.ae_load_table('i18n.farmland_categories', '{data_folder}/i18n/i18n.farmland_categories_20200527_nl.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('i18n.farmland_categories', '{data_folder}/i18n/i18n.farmland_categories_20200527_en.txt'); COMMIT;

BEGIN; SELECT setup.ae_load_table('i18n.mobile_source_off_road_categories', '{data_folder}/i18n/i18n.mobile_source_off_road_categories_20200619_nl.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('i18n.mobile_source_off_road_categories', '{data_folder}/i18n/i18n.mobile_source_off_road_categories_20200619_en.txt'); COMMIT;
