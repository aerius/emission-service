...
BEGIN; SELECT setup.ae_load_table('dev.road_speed_profiles', '{data_folder}/public/road_speed_profiles_20200326.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.road_category_emission_factors', '{data_folder}/public/road_category_emission_factors_20200326.txt'); COMMIT;

/* Farm animal category and -lodging data */
BEGIN; SELECT setup.ae_load_table('dev.farm_animal_categories', '{data_folder}/public/farm_animal_categories_20200512.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.farm_lodging_system_definitions', '{data_folder}/public/farm_lodging_system_definitions_20200512.txt'); COMMIT;

BEGIN; SELECT setup.ae_load_table('dev.farm_lodging_types', '{data_folder}/public/farm_lodging_types_20200512.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.farm_lodging_type_emission_factors', '{data_folder}/public/farm_lodging_type_emission_factors_20200512.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.farm_lodging_types_other_lodging_type', '{data_folder}/public/farm_lodging_types_other_lodging_type_20200512.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.farm_lodging_types_to_lodging_system_definitions', '{data_folder}/public/farm_lodging_types_to_lodging_system_definitions_20200512.txt'); COMMIT;

BEGIN; SELECT setup.ae_load_table('dev.farm_additional_lodging_systems', '{data_folder}/public/farm_additional_lodging_systems_20200512.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.farm_additional_lodging_system_emission_factors', '{data_folder}/public/farm_additional_lodging_system_emission_factors_20200512.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.farm_additional_lodging_systems_to_lodging_system_definitions', '{data_folder}/public/farm_additional_lodging_systems_to_lodging_system_definitions_20200512.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.farm_lodging_types_to_additional_lodging_systems', '{data_folder}/public/farm_lodging_types_to_additional_lodging_systems_20200512.txt'); COMMIT;

BEGIN; SELECT setup.ae_load_table('dev.farm_reductive_lodging_systems', '{data_folder}/public/farm_reductive_lodging_systems_20200512.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.farm_reductive_lodging_system_reduction_factors', '{data_folder}/public/farm_reductive_lodging_system_reduction_factors_20200512.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.farm_reductive_lodging_systems_to_lodging_system_definitions', '{data_folder}/public/farm_reductive_lodging_systems_to_lodging_system_definitions_20200512.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.farm_lodging_types_to_reductive_lodging_systems', '{data_folder}/public/farm_lodging_types_to_reductive_lodging_systems_20200512.txt'); COMMIT;
...
BEGIN; SELECT setup.ae_load_table('dev.shipping_maritime_category_emission_factors', '{data_folder}/public/shipping_maritime_category_emission_factors_20190321.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('dev.shipping_maritime_category_source_characteristics', '{data_folder}/public/shipping_maritime_category_source_characteristics_20190321.txt'); COMMIT;

/* Inland shipping data */
BEGIN; SELECT setup.ae_load_table('dev.shipping_inland_categories', '{data_folder}/public/shipping_inland_categories_20140327.txt'); COMMIT;
...
BEGIN; SELECT setup.ae_load_table('dev.shipping_inland_category_source_characteristics', '{data_folder}/public/shipping_inland_category_source_characteristics_20200616.txt'); COMMIT;
