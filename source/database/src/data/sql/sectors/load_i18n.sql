...
BEGIN; SELECT setup.ae_load_table('i18n.sectors', '{data_folder}/temp/i18n.temp_sectors_20200527_nl.txt'); COMMIT;
BEGIN; SELECT setup.ae_load_table('i18n.sectors', '{data_folder}/temp/i18n.temp_sectors_20200527_en.txt'); COMMIT;
