...
/* machinery_fuel_types_to_sectors
 * -------------------------------
 ...
 */
CREATE TABLE machinery_fuel_types_to_sectors (
	machinery_fuel_type_id integer NOT NULL,
	sector_id integer NOT NULL,
	
	CONSTRAINT machinery_fuel_types_to_sectors_pkey PRIMARY KEY (machinery_fuel_type_id, sector_id),
	CONSTRAINT machinery_fuel_types_to_sectors_fkey_sectors FOREIGN KEY (sector_id) REFERENCES sectors,
	CONSTRAINT machinery_fuel_types_to_sectors_fkey_machinery_fuel_types FOREIGN KEY (machinery_fuel_type_id) REFERENCES machinery_fuel_types
);
