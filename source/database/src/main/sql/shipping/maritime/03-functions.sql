...
BEGIN
	...
	ELSE
			SELECT ST_LineSubstring(transfer_route, 0, maneuver_fraction) INTO maneuver_part;
			SELECT ST_LineSubstring(transfer_route, maneuver_fraction, 1) INTO normal_part;
	END IF;
